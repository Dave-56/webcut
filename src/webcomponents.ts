...
customElements.define('webcut-clear-selected-tool', defineCustomElement(WebCutClearSelectedTool, { shadowRoot: false }));
customElements.define('webcut-delete-current-tool', defineCustomElement(WebCutDeleteCurrentTool, { shadowRoot: false }));
customElements.define('webcut-split-current-tool', defineCustomElement(WebCutSplitCurrentTool, { shadowRoot: false }));
